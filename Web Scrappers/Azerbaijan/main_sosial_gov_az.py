...
def sosial_gov_az(webpage, start_page_number, end_page_number, category, keyword, search_keyword):   
   ...
   #print(soup)
   # Extracting urls
   for link in soup.findAll('div', class_="col-sm-8"): 
      print(link)
      url = ""
      date = ""
      try:  
          url = link.find('a')['href']
          date = link.find('p', class_='post-meta').text.strip()
          print(url,date)
   ...
   if start_page_number < end_page_number:
       ...
       sosial_gov_az(webpage, start_page_number,end_page_number, category_name, keyword, search_keyword)
    ...
    if categoryId:
        for idp in idps:
            for keyword in keywords:
                ...
                webpage = f'https://sosial.gov.az/search?q={search_keyword}&page='
                sosial_gov_az(webpage, start_page_number,end_page_number, category_name, keyword, search_keyword)
