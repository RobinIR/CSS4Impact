...
def vergiler_az(webpage, start_page_number, end_page_number, category, keyword, search_keyword):   
   ...
   #print(soup)
   # Extracting urls
   for link in soup.findAll('div', class_="col-md-10"): 
      
      try:
        url = link.find('a')['href']
        date = link.find('span', class_='meta_date').text.strip()
   ...
   if start_page_number < end_page_number:
      ...
      vergiler_az(webpage, start_page_number,end_page_number, category_name, keyword, search_keyword)
    ...
    if categoryId:
        for idp in idps:
            for keyword in keywords:
                ...
                webpage = f"https://vergiler.az/search.php?query={search_keyword}&page=/"
                vergiler_az(webpage, start_page_number,end_page_number, category_name, keyword, search_keyword)