...
# Get the current timestamp
            ...
            #NLP
            totalPriorityValue, persons, locations, idpKeywordSimilarityList, categoryKeywordSimilarityList, organizations = georgian_nlp.georgian_file_sort(file_path, language, category)
            payload = {
                "title": title,
